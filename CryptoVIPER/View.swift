...
class CryptoViewController: UIViewController, AnyView, UITableViewDelegate, UITableViewDataSource { // önce ui sonra anyview yazılmalı
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.contentConfiguration = content // contenti cell ile bagladık
